...
def generate_pagees_recursive(content_dir, template_path, public_dir, basepath):
    ...
    for entry in entries:
        ...
        if os.path.isdir(src):
            ...
            generate_pagees_recursive(src, template_path, dst, basepath)
            ...
            generate_page(src, template_path, dest_html,basepath)
